...
| [02-operator-approves-irreversible-step](./02-operator-approves-irreversible-step/interventions/int-001.json) | Draft capability reaches its irreversible step | risky-irreversible at step 8 | claimed int-001, inspected the filled form, approved | approve | succeeded: newAccountNumber=[account number] | yes |
